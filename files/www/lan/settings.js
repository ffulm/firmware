...
function appendSetting(p, path, value, mode)
{
	...
	case "publish_map":
		...
		addHelpText(b, "Mit wie vielen Informationen soll dieser Knoten zur Knotenkarte beitragen? (Wenig: Name/Version/Position/Kontakt, Viel: Modell/Uptime/CPU-Auslastung, Alles: Speicherauslastung/IP-Adressen)");
		break;
	case "limit_egress":
